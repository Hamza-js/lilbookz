...
const ListCostumersInvoices = ({
  ...
  const handleDeleteInvoice = async (invoice) => {
    ...
    if (loggedInStatus === true) {
      ...
      const url = `${baseUrl}/api/deleteCustomerInvoice?customerid=${userData.customerid}`;
  ...
  const resentInvoice = (invoice) => {
    ...
    if (loggedInStatus === true) {
      ...
      formdata.append('customerid', userData.customerid);
      formdata.append('clientid', invoice.clientid);
  ...
  const openInvoice = (invoice) => {
    ...
    if (loggedInStatus === true) {
      ...
      closeDrawer();
      const url =
        'https://www.lilbookz.co.uk/customer-invoice.php?id=' +
        invoice.id +
        '&cli=' +
        invoice.clientid +
        '&cust=' +
